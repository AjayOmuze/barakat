		  ...
		  <?php if (have_posts()) : ?>
            <?php while (have_posts()): the_post(); ?>
			  ...
			  <div class="blog_detail_wrapper">
				...
				<?php if(is_array($image_gallery) && count($image_gallery) > 0): ?>
					
					<div class="clearfix">&nbsp;</div>
					
					<div class="row">
					
					<?php $i=1; foreach($image_gallery as $gallery_image): ?>
					
						<?php if(isset($gallery_image['sizes']['thumbnail'])): ?>
						
							<div class="col-md-3">
							
								<a href="<?php echo $gallery_image['url']; ?>" class="gallery_item_fancybox" rel="gallery">
									<img src="<?php echo $gallery_image['sizes']['thumbnail']; ?>" class="img-responsive" />
								</a>
