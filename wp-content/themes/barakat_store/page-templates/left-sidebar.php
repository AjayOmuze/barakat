...
<section>
  ...
  <div class="blog_sec">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3 leftside">
          <h4>About</h4>
            ...
            <div class="row">
              <?php foreach ($galleryObj as $image): ?>
                <div class="col-md-2 col-sm-2 col-xs-4">
                  <a class="fancybox" href="<?php echo $image['url'] ?>" data-fancybox-group="gallery" title="<?php echo $image['title'] ?>">
                    <img src="<?php echo $image['sizes']['thumbnail'] ?>" title="<?php echo $image['title'] ?>" alt="<?php echo $image['title'] ?>" />
                  </a>
                </div>
              <?php endforeach; ?>
            </div>
